...
public class Appointment {
    ...
    private Long assignedVetId;  // User ID of assigned vet
    ...
    public Appointment(Long petId, String owner, LocalDate date, String time, String vetUsername, String vet, String status) {
        this.petId = petId;
        this.owner = owner;
        this.date = date;
        this.time = time;
